      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <p>Proudly serving Santa Barbara with expert collision repair for over 25 years.</p>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} Happy&apos;s Collision Center. All rights reserved.</p>
